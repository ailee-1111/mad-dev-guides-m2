...
spec:
  rules:
    - host: stuff-myspace-%userid%.apps.cluster-fs55g.fs55g.sandbox3296.opentlc.com
      http:
        paths:
          - path: /
            pathType: Prefix
...
[source, bash]
----
curl stuff-myspace-%userid%.apps.cluster-fs55g.fs55g.sandbox3296.opentlc.com
----
...
the-service   the-service-myspace-%userid%.apps.cluster-fs55g.fs55g.sandbox3296.opentlc.com          the-service   8080                 None
----
...
[source, bash]
----
curl the-service-myspace-%userid%.apps.cluster-fs55g.fs55g.sandbox3296.opentlc.com
----
