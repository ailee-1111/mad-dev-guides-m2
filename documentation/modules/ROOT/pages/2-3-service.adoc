...
spec:
  rules:
    - host: stuff-myspace-%userid%.apps.cluster-8md2z.8md2z.sandbox312.opentlc.com
      http:
        paths:
          - path: /
            pathType: Prefix
...
[source, bash]
----
curl stuff-myspace-%userid%.apps.cluster-8md2z.8md2z.sandbox312.opentlc.com
----
...
the-service   the-service-myspace-%userid%.apps.cluster-8md2z.8md2z.sandbox312.opentlc.com          the-service   8080                 None
----
...
[source, bash]
----
curl the-service-myspace-%userid%.apps.cluster-8md2z.8md2z.sandbox312.opentlc.com
----
